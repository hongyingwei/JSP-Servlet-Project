...
<script type="text/javascript">
	function addProduct() {
		window.location.href = "${pageContext.request.contextPath}/AdminProductServlet?method=addProductUI&pflag=0";
	}
</script>
<script type="text/javascript">
	$(function() {
		$(".up").click(function() {
			if(confirm("确定上架改商品？")){
				...
				window.location.href = "${pageContext.request.contextPath}/AdminProductServlet?method=upProduct&pid="+pid+"&currentPageNum="+currentPageNum;
			}
		});	
	});
</script>
				...
				<tr>
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${page.list }" varStatus="statu" begin="0" var="product">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a href="javascript:void(0);" id="${product.pid}" class="up"> <img
