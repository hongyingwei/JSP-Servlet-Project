		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${product_Hots }" var="p">
						<div class="col-md-2 product" style="text-align:center;height:210px;padding:10px 0px;">
            ...
            -->
            <div class="container-fluid">
				<img src="img/ad/6.jpg" width="100%" height="100px"/>
			</div>
			<!--
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${product_News }" var="p">
					<div class="col-md-2 product" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath}/ProductServlet?method=findProductByPid&pid=${p.pid}">
							<img src="${pageContext.request.contextPath}/${p.pimage}" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath}/ProductServlet?method=findProductByPid&pid=${p.pid}" style='color:#666'>${p.pname }</a></p>
