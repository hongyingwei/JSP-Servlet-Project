...
<style>
	...
	<%--分页显示的开始 --%>
    	<div style="text-align:center; margin-top: 50px; font-size: 16px;" class="page">
    		...
    		<input type="text" id="pagenum" name="pagenum" size="1" style="background-color: #ccc;"/> <input type="button" value="前往" onclick="jump()" style="background-color: #fff; border: 2px solid #ccc"/>
